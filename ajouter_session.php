       ...
       <div class="user-section">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
               <div class="col-lg-12">
                    <h1 class="page-header">forme d'ajoute session  </h1>
                ...
                <!--End Page Header -->
				 ...
				 , 
                    ...
                    <form action="ajouter_session2.php" method="POST">
                        
						
						
   <label class="control-label" for="success" >  jour:</label>
   <input type="number" class="form-control" id="success" name="jour" />						
                                  
   <label class="control-label" for="success" > thème:</label>
   <input type="text" class="form-control" id="success" name="theme" />

<label class="control-label" for="success" >  heure de début:</label>
   <input type="time" class="form-control" id="success" name="hdb" />
<label class="control-label" for="success" >   heure de fin,:</label>
   <input type="time" class="form-control" id="success" name="hf" />
   


   <label class="control-label" for="success" >  le président  :</label>
   <input type="text" class="form-control" id="success" name="prsdnt" />  
