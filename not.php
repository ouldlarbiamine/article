    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">saisir la note d'article</h1>
...
?>
                    ...
                    <form action="not3.php" method="POST">
                        
                      



   <input type="number" class="form-control" id="success" name="nott" />
