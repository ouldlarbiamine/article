...
$query1= mysqli_query($con, "SELECT MAX(`id_session`) FROM `session` WHERE 1");
...
$query2=mysqli_query($con,"INSERT INTO `session` (`id_session`, `theme`, `jour`, `heure_de_debut`, `heure_de_fin`, `president`) VALUES ('$matricule', '$theme', '$jour', '$hdb', '$hf', '$prsdnt');");
...
?>
   ...
   <label class="control-label" for="success" > jour:<?php echo "$jour";?></label><br>
   <label class="control-label" for="success" > thème:<?php echo "$theme";?></label><br>
   <label class="control-label" for="success" > heure de début:<?php echo "$hdb";?></label><br>
<label class="control-label" for="success" > heure de fin:<?php echo "$hf";?></label><br>

   <label class="control-label" for="success" > le président  : <?php echo "$prsdnt";?></label><br>
