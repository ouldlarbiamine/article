...
$query1= mysqli_query($con, "SELECT MAX(`use`) FROM `expert` WHERE 1");
...
$query2=mysqli_query($con,"INSERT INTO `expert` (`id_expert`, `SSN`, `nom`, `titre`, `universite`, `adresse`, `numero_de_telephone`, `numero_de_telecopie`, `adresse_electronique`, `mot_de_passe`, `use`) VALUES ('$matricule', '$ssn', ' $nom', '$titre', '$univ', '$adresse', '$telephone', '$fax', '$imail', '$mot_de_passe', '$matricule');");
...
?>
   ...
   <label class="control-label" for="success" > matricule:<?php echo "$matricule";?></label><br>
...
<label class="control-label" for="success" > SSN:<?php echo "$ssn";?></label><br>
   ...
   <label class="control-label" for="success" > adresse: <?php echo "$adresse";?></label><br>
     ...
     <label class="control-label" for="success" >  numéro de téléphone:<?php echo "$telephone";?></label><br>

        <label class="control-label" for="success" >  numéro de télécopie:<?php echo "$fax";?></label><br>

        <label class="control-label" for="success" >  adresse électronique,: <?php echo "$imail";?></label><br>
    <label class="control-label" for="success" > mot pass:<?php echo "$mot_de_passe";?></label><br>
