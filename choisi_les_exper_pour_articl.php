        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">la liste des session</h1>
...
$query=  mysqli_query($con,"SELECT `id_session`,`theme`,`jour`,`heure_de_debut`,`heure_de_fin`,`president` FROM `session` WHERE 1");
...
echo "<table border=\"1\"  >";
     //   echo "<caption>  </caption>";
        echo "<tr><td> jour  </td><td> theme </td>  <td>heure_de_debut</td><td>heure_de_fin</td> <td>president</td> </tr>";
     
while ($row= mysqli_fetch_assoc($query)) {//
    $id_session=$row['id_session']; 
	$themee=$row['theme'];  
	$jour=$row['jour'];  
	$heure_de_debut=$row['heure_de_debut'];  
	$heure_de_fin=$row['heure_de_fin'];  
	$president=$row['president'];  
                                                 ...
                                                 echo "<tr><td>  $jour </td><td>$themee  </td> <td>$heure_de_debut</td><td>$heure_de_fin</td><td>$president</td> </tr>";
